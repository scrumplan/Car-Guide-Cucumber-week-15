...
public class BuyStep {
    ...
    public void iClickOnFindMyNextCarTabOnUsedCardSearch() {
        new UsedCarsPage().clickingOnFindMyNextCarButton();
    }
}
